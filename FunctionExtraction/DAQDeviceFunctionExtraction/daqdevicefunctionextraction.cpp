...
bool DAQDeviceFunctionExtraction::connect(const QString &boardName) {
...
unsigned int DAQDeviceFunctionExtraction::getChannelsCount() {
...
double DAQDeviceFunctionExtraction::getFrequency() {
    return frequency;
}

Range DAQDeviceFunctionExtraction::getRange() {
    return rangeBoard;
}

bool DAQDeviceFunctionExtraction::setParameters(unsigned int channel, double gain, Range range, unsigned int filter) {
...
bool DAQDeviceFunctionExtraction::start() {
    if (board.hbuf != NULL) {
...
QList<FunctionElement> DAQDeviceFunctionExtraction::getData() {
...
void DAQDeviceFunctionExtraction::abort() {
    Hbuf hbuf;
...
void DAQDeviceFunctionExtraction::stop() {
    Hbuf hbuf;
...
void DAQDeviceFunctionExtraction::disconnect() {
